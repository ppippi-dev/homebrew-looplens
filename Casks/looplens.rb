cask "looplens" do
  ...
  url "https://github.com/ppippi-dev/looplens-releases/releases/download/v#{version}/LoopLens-#{version}-mac-#{arch}.dmg"
  name "LoopLens"
  desc "Monitor Claude Code/OpenCode run timelines and stop causes"
  homepage "https://github.com/ppippi-dev/looplens-releases"
